...
export function AuthModal({
  ...
  function buildProfile(userId: string, userEmail: string, metadata?: Record<string, unknown>): Profile {
    ...
    const metaRefCode = metadata ? metadata["ref_code"] : undefined;
    return {
      id: userId,
      name:
      ...
      ref_code: (typeof metaRefCode === "string" && metaRefCode) || generateRefCode(normalized),
    ...
    try {
      ...
      const message =
        err instanceof Error
          ? err.message
          : "We could not complete authentication. Please check your connection and try again.";
